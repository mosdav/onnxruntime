...
if (onnxruntime_USE_OPENVINO)
  ...
  if (onnxruntime_USE_OPENVINO_BINARY)
    set(OPENVINO_INCLUDE_DIR $ENV{INTEL_OPENVINO_DIR}/linux/inference-engine/include)
    ...
    if(WIN32)
      ...
      set(OPENVINO_LIB_DIR $ENV{INTEL_OPENVINO_DIR}/linux/inference-engine/arm64/Release/lib)
    endif()
